...
<div class="col-lg-9 mt-2">
  <div class="card">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <button class="<?php echo (empty($row['status']) || $row['status'] != 1) ? "btn btn-secondary btn-sm me-1 text-nowrap  disabled" :  "btn btn-success btn-sm text-nowrap"; ?>" data-bs-toggle="modal" data-bs-target="#ready<?php echo $row['id_list_order'] ?>">Ready</button>
                  </div>
                </td>
              </tr>
          <?php
    ...
    ?>
        ...
        <!-- Modal Siap Saji -->
        <div class="modal fade" id="ready<?php echo $row['id_list_order'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-fullscreen-md-down">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_ready_orderitem.php" method="POST">
                  <input type="hidden" name="id" value="<?php echo $row['id_list_order'] ?>">
                  <div class="row">
                    <div class="col-lg-8">
                      <div class="form-floating mb-3">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" name="ready_orderitem_validate" value="12345">Ready</button>
              </div>
              </form>
            </div>
