...
<nav class="navbar navbar-expand navbar-dark bg-primary sticky-top">
  <div class="container-lg">
    <a class="navbar-brand" href="home"></i>SORABI Ceu Ikah</a>
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end mt-2">
            ...
            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#ModalUbahPassword"><i class="bi bi-key"></i>Change Password</a></li>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-floating mb-3">
                <input disabled type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="username" value="<?php echo $_SESSION['username_restoran'] ?>" required>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-floating mb-3">
                ...
                <div class="invalid-feedback">Masukan Ulangi Password Baru</div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-floating mb-3">
                ...
                <div class="invalid-feedback">Masukan No Hp</div>
              </div>
            </div>
          </div>
          <div class="row">
