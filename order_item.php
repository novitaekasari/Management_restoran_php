            ...
            <tr>
              ...
              <td>
                <div class="d-flex">
                  ...
                  <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1  disabled" :  "btn btn-danger btn-sm"; ?>" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_list_order'] ?>"><i class="bi bi-trash3"></i></button>
                </div>
              </td>
            </tr>
          <?php
...
<div id="strukContent" class="d-none">
  <style>
    ...
    #struk tbody tr:nth-child(even) {
      background-color: #f2f2f2;
    }

    #struk tbody tr:hover {
  ...
  <div id="struk">
    ...
    <h2>Sorabi Ceu Ikah</h2>
    <h6>Jl.Parigimulya Kec. Cipunagara Kab. Subang</h6>
    ----------------------------------------------------------------------------------------------------------------------------------------
    <p>Kode Order: <?php echo $kode ?></p>
    <p>Meja: <?php echo  $meja ?></p>
    <p>Pelanggan: <?php echo $pelanggan ?></p>
    <p>Waktu Order: <?php echo date('d/m/ H:i:s', strtotime($result[0]['waktu_order'])) ?></p>
