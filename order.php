                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-floating mb-3">
                      ...
                      <div class="invalid-feedback">Masukan Kode Order</div>
                    </div>
                  </div>
                  <div class="col-lg-2">
                    <div class="form-floating mb-3">
                      ...
                      <div class="invalid-feedback">Masukan No Meja</div>
                    </div>
                  </div>
                  <div class="col-lg-7">
                    <div class="form-floating mb-3">
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_edit_order.php" method="POST">
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="form-floating mb-3">
                        <input readonly type="text" class="form-control" id="kodeorder" name="kode_order" value="<?php echo $row['id_order'] ?>" readonly>
                        <label for="kodeorder">Kode Order</label>
                        <div class="invalid-feedback">Masukan Kode Order</div>
                      </div>
                    </div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-danger btn-sm"; ?>" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_order'] ?>"><i class="bi bi-trash3"></i></button>
                  </div>
                </td>
              </tr>
            <?php
