...
<head>
    ...
    <title>Aplikasi Sorabi Ceu</title>
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="proses/proses_register.php" method="POST">
            <form action="register.php" method="post">
                ...
                <button class="btn btn-primary w-100 py-2" type="submit" name="input_register_validate" value="register">Signup</button>
                <p class="mt-5 mb-3 text-body-secondary">&copy; Novita Ekasari <?php echo date("Y") ?></p>
            </form>
    </main>
    </div>
</body>
