...
$query_chart = mysqli_query($conn, "SELECT nama_menu, tb_menu.id, SUM(tb_list_order.jumlah) AS total_jumlah FROM tb_menu
...
<div class="col-lg-9 mt-2">
  ...
  <div class="card mt-4 border-0 bg-light">
    <div class="card-body text-center">
      <h5 class="card-title">SORABI Ceu Ikah</h5>
      <p class="card-text">Aplikasi pemesanan sorabi yang mudah dan praktis. <br> Nikmati beragam menu Sorabi favorit anda dengan beberapa, klik, pesan, bayar, dan lacak pesanan anda dengan mudah melalui aplikasi ini. </p>
        ...
        new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              ...
              borderWidth: 1,
              backgroundColor:[
                'rgba(255, 47, 41, 1)', 'rgba(47, 41, 255, 0.92)','rgba(20, 156, 49, 0.92)','rgba(184, 103, 20, 0.92)'
              ]
            }]
          },
          options: {
