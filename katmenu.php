              ...
              ?>
                <tr>
                  ...
                  <td class="d-flex">
                    ...
                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_kat_menu'] ?>"><i class="bi bi-trash3"></i></button>
                  </td>
                </tr>
              <?php
              }
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      ...
                      <div class="invalid-feedback">Masukan Jenis Menu</div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      ...
                      <div class="invalid-feedback">Masukan Kategori Menu</div>
                    </div>
                  </div>
                </div>
            </div>
                    ...
                    <select class="form-select" aria-label="Default select example" name="jenismenu" id="" required>
                      ...
                      foreach ($data as $key => $value) {
                        if ($row['jenis_menu'] == $key + 1) {
                          ...
                          echo "<option value=" . ($key + 1) . ">$value</opti'on>";
                        }
                      }
                      ?>
                    </select>
...
<?php
  ...
  if (empty($result)) {
    echo "Data Menu Makanan tidak ada";
  } else {
?>
